...
class DEDUG_OC():
    def __init__(self):
        print("ROS Initial!")
        rospy.init_node('DEDUG_OC343', anonymous=False)
        ...
        self.path_log = "/home/stivietnam/catkin_ws/src/ros_canBus/scripts_debug/debug/OC12_debug.txt"
    ...
    def callback_conveyor12(self, data):
        ...
        self.timeStampe_conveyor2 = rospy.Time.now()
        self.writeDataOC(self.status_conveyor12)
