...
class DEDUG_OC():
    def __init__(self):
        print("ROS Initial!")
        rospy.init_node('DEDUG_OC566', anonymous=False)
        ...
        self.path_log = "/home/stivietnam/catkin_ws/src/ros_canBus/scripts_debug/debug/OC21_debug.txt"
    ...
    def callback_conveyor21(self, data):
        ...
        self.timeStampe_conveyor1 = rospy.Time.now()
        self.writeDataOC(self.status_conveyor21)
