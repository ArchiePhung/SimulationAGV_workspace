...
class DEDUG_OC():
    def __init__(self):
        print("ROS Initial!")
        rospy.init_node('DEDUG_OC344', anonymous=False)
        ...
        self.timeStampe_conveyor22 = rospy.Time.now()

        self.path_log = "/home/stivietnam/catkin_ws/src/ros_canBus/scripts_debug/debug/OC22_debug.txt"
    ...
    def callback_conveyor22(self, data):
        ...
        self.timeStampe_conveyor22 = rospy.Time.now()
        self.writeDataOC(self.status_conveyor22)

    def detectLost_OC12(self):
        delta_t = rospy.Time.now() - self.timeStampe_conveyor22
