...
class CAN_ROS():
	def __init__(self):
		...
		# ----- CONVEYER ----- #
		# - PUBLISH
		self.pub_statusConveyor1 = rospy.Publisher("/status_conveyor13", Status_conveyor, queue_size= 10)
		self.status_conveyor13 = Status_conveyor()

		self.pub_statusConveyor2 = rospy.Publisher("/status_conveyor23", Status_conveyor, queue_size= 10)
		self.status_conveyor21 = Status_conveyor()

		self.pub_statusConveyor3 = rospy.Publisher("/status_conveyor12", Status_conveyor, queue_size= 10)
		self.status_conveyor12 = Status_conveyor()

		self.pub_statusConveyor4 = rospy.Publisher("/status_conveyor22", Status_conveyor, queue_size= 10)
		self.status_conveyor22 = Status_conveyor()

		self.pub_statusConveyor5 = rospy.Publisher("/status_conveyor11", Status_conveyor, queue_size= 10)
		self.status_conveyor11 = Status_conveyor()

		self.pub_statusConveyor6 = rospy.Publisher("/status_conveyor21", Status_conveyor, queue_size= 10)
		self.status_conveyor21 = Status_conveyor()
		# --
	...
	def analysisFrame_receivedCAN(self):
		...
		# -- OC No.1 - CONVEYOR_No12
			...
			self.status_conveyor13.status = self.data_receivedCAN.byte0
			...
			self.status_conveyor21.status = self.data_receivedCAN.byte4
		...
		# -- OC No.2 - CONVEYOR_No34
			...
			self.status_conveyor12.status 			 = self.data_receivedCAN.byte0
			...
			self.status_conveyor22.status 			 = self.data_receivedCAN.byte4
		...
		# -- OC No.3 - CONVEYOR_No56
			...
			self.status_conveyor11.status 			 = self.data_receivedCAN.byte0
