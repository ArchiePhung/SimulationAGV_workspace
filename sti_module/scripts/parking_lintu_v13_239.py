...
class StiAutomaticParking():
    def __init__(self):
        ...
        self.bu_khoang_cach        = rospy.get_param('~bu_khoang_cach',0.033)
    ...
    def average_filter(self, sl_loc, wait_time):
        x_ht = z_ht = g_ht = .0
        x = z = g = .0
        dem = 0
        dem_gt_dau = 0
    ...
    def raa(self):
        ...
        while not rospy.is_shutdown() :
            ...
            #B2: Tinh goc can quay, tt_x , tt_z
                ...
                self.rb_x, self.rb_z, self.rb_g = self.average_filter(self.sl_loc, 5)
            ...
            #B33: Quay lan 1
                ...
                twist = Twist()
                if fabs(theta) > 0.025:
                    if direc_turn_first_time == 1: # quay trai
                        twist.linear.x = 0.0
                        twist.angular.z = 0.3
                    elif direc_turn_first_time == 2: # quay phai
                        twist.linear.x = 0.0
                        twist.angular.z = -0.3
