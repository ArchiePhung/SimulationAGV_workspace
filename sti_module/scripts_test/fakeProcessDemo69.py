...
class FakeProcess(threading.Thread):
    def __init__(self, threadID):
        ...
        self.typeSoundPickPallet = 5
        self.typeSoundDownPallet = 6
        self.typeSoundCharging = 8
        self.pathSoundMoving = '/home/stivietnam/catkin_ws/src/sti_module/sound/movingAGV.mp3'
        self.pathSoundMovingCharging = '/home/stivietnam/catkin_ws/src/sti_module/sound/movingAGV.mp3'
        ...
        self.pathSoundPickPallet = '/home/stivietnam/catkin_ws/src/sti_module/sound/pickPallet.mp3'
        self.pathSoundDownPallet = '/home/stivietnam/catkin_ws/src/sti_module/sound/downPallet.mp3'
        self.pathSoundCharging = '/home/stivietnam/catkin_ws/src/sti_module/sound/charging.mp3'
        ...
        path.direction = 1
        path.pointOne = Pose()
        path.pointOne.position.x = -16.42
        path.pointOne.position.y = -9.036
        path.pointSecond = Pose()
        path.pointSecond.position.x = -9.826 #-12.826
        path.pointSecond.position.y = -9.036
        path.velocity = 0.32
        path.movableZone = 1.2
        self.plan1.pathInfo.append(path)
        ...
        path.direction = 2
        path.pointOne = Pose()
        path.pointOne.position.x = -9.826 #-12.826
        path.pointOne.position.y = -9.036
        path.pointSecond = Pose()
        path.pointSecond.position.x = -11.326
        path.pointSecond.position.y = -10.5
        path.velocity = 0.25
        path.numberPts = 150
        path.movableZone = 1.2
        path.pointMid = Pose()
        path.pointMid.position.x = -11.326
        path.pointMid.position.y = -9.036
        self.plan1.pathInfo.append(path)
        ...
        #-- VT1 to VT2 -----------------------------------------------------------
        self.plan2.enable = 1
        self.plan2.target_x = -24.025
        self.plan2.target_y = -9.036
        self.plan2.target_z = 0.
        ...
        path.direction = 1
        path.pointOne = Pose()
        path.pointOne.position.x = -11.326
        path.pointOne.position.y = -10.5
        path.pointSecond = Pose()
        path.pointSecond.position.x = -12.826
        path.pointSecond.position.y = -9.036
        path.velocity = 0.25
        path.numberPts = 150
        path.movableZone = 1.2
        ...
        path.direction = 1
        path.pointOne = Pose()
        path.pointOne.position.x = -12.826
        path.pointOne.position.y = -9.036
        path.pointSecond = Pose()
        path.pointSecond.position.x = -21.625
        path.pointSecond.position.y = -9.036
        path.velocity = 0.32
        path.movableZone = 1.2
        self.plan2.pathInfo.append(path)
        ...
        path.direction = 1
        path.pointOne = Pose()
        path.pointOne.position.x = -21.625
        path.pointOne.position.y = -9.036
        path.pointSecond = Pose()
        path.pointSecond.position.x = -22.825
        path.pointSecond.position.y = -7.836
        path.velocity = 0.25
        path.numberPts = 150
        path.movableZone = 1.2
        path.pointMid = Pose()
        path.pointMid.position.x = -22.825
        path.pointMid.position.y = -9.036
        self.plan2.pathInfo.append(path)
        ...
        path.direction = 2
        path.pointOne = Pose()
        path.pointOne.position.x = -22.825
        path.pointOne.position.y = -7.836
        path.pointSecond = Pose()
        path.pointSecond.position.x = -24.025
        path.pointSecond.position.y = -9.036
        path.velocity = 0.25
        path.numberPts = 150
        path.movableZone = 1.2
        ...
        path.direction = 1
        path.pointOne = Pose()
        path.pointOne.position.x = -24.025
        path.pointOne.position.y = -9.036
        path.pointSecond = Pose()
        path.pointSecond.position.x = -16.42
        path.pointSecond.position.y = -9.036
        ...
        path.pointOne.position.y = -9.036
        path.pointSecond = Pose()
        path.pointSecond.position.x = -17.884
        path.pointSecond.position.y = -10.5
        path.velocity = 0.25
        path.numberPts = 150
        path.movableZone = 1.2
        ...
        #-- sac to VT2 ---------------------------------------------------
        self.plan4.enable = 1
        self.plan4.target_x = -24.025
        self.plan4.target_y = -9.036
        ...
        path.pointOne.position.y = -10.5
        path.pointSecond = Pose()
        path.pointSecond.position.x = -19.348
        path.pointSecond.position.y = -9.036
        path.velocity = 0.25
        path.numberPts = 150
        path.movableZone = 1.2
        ...
        path.direction = 1
        path.pointOne = Pose()
        path.pointOne.position.x = -19.348
        path.pointOne.position.y = -9.036
        path.pointSecond = Pose()
        path.pointSecond.position.x = -21.625
        path.pointSecond.position.y = -9.036
        ...
        path.pointOne.position.y = -9.036
        path.pointSecond = Pose()
        path.pointSecond.position.x = -9.826
        path.pointSecond.position.y = -9.036
        path.velocity = 0.32
        path.movableZone = 1.2
        ...
        self.movePointSAC.target_x = -17.884
        self.movePointSAC.target_y = -10.5

        self.movePointVT1.enable = 2
        self.movePointVT1.target_x = -11.326
        self.movePointVT1.target_y = -10.5

        self.movePointVT2.enable = 2
        self.movePointVT2.target_x = -24.025
        self.movePointVT2.target_y = -9.036


        # parking
        self.msgRequestParkingVT2.modeRun = 1
        self.msgRequestParkingVT2.poseTarget.position.x = -25.375
        self.msgRequestParkingVT2.poseTarget.position.y = -9.036
        self.msgRequestParkingVT2.poseTarget.orientation.z = 0.
        self.msgRequestParkingVT2.poseTarget.orientation.w = 1.
        self.msgRequestParkingVT2.offset = 1.2

        self.msgRequestParkingVT1.modeRun = 1
        self.msgRequestParkingVT1.poseTarget.position.x = -11.326
        ...
        self.msgRequestParkingSAC.poseTarget.position.x = -17.884
    ...
    def pSound(self, type):
        if self.app_button.bt_spk_on:
            ...
            elif self.typeSoundNow == self.typeSoundPickPallet:
                dentaTime = rospy.get_time() - self.saveTimeSound
                if dentaTime < 2.:
                    playsound(self.pathSoundPickPallet, block=True)

                elif dentaTime > 4.:
                    self.saveTimeSound = rospy.get_time()

            elif self.typeSoundNow == self.typeSoundDownPallet:
                dentaTime = rospy.get_time() - self.saveTimeSound
                if dentaTime < 3.:
                    playsound(self.pathSoundDownPallet, block=True)

                elif dentaTime > 6.:
                    self.saveTimeSound = rospy.get_time()

            elif self.typeSoundNow == self.typeSoundCharging:
                dentaTime = rospy.get_time() - self.saveTimeSound
                if dentaTime < 2.:
                    playsound(self.pathSoundCharging, block=True)
    ...
    def moveQT1(self):
        if self.process == 0:
            ...
            if self.sttParking == 1:
                self.requestSound = self.typeSoundPickPallet
            ...
            if self.sttParking == 1:
                self.requestSound = self.typeSoundDownPallet
            ...
            if self.sttParking == 1:
                self.requestSound = self.typeSoundCharging
    ...
    def scripMove2(self):
        ...
        self.NN_infoRespond.battery = 250
