...
class BroadcasterParking(threading.Thread):
    def __init__(self, threadID):
        ...
        self.poseTargetTranfrom = Pose()
        self.needBroadcaster = False
    ...
    def resetALl(self):
        self.is_transform = False
        self.isTransFormPose = False
        self.msgPathParking.enable = False
    ...
    def run(self):
        ...
        while not self.shutdown_flag.is_set(): 
            if self.process == 0: # cho du tin hieu
                ...
                if self.makePath():
                    self.msgPathParking.enable = True
                    self.process = 4
    ...
    try:
        ...
        while not rospy.is_shutdown():
            if br.is_request_parking:
                if br.needBroadcaster:
                    br.poseTargetTranfrom = br.req_parking.poseTarget
                    br.sendTransform('frame_map_nav350', 'frame_target', br.poseTargetTranfrom) # -- edit 03/03/2022: frame_map_nav350 frame_global_map
