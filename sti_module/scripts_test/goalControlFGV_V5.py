...
# them tinh nang an toan cho fgv phuc vu demo
...
from sti_msgs.msg import PathInfo, PointRequestMove, ListPointRequestMove, LineRequestMove, HC_info, MotorDrive_respond, Velocities, Status_goal_control, Zone_lidar_2head
...
class GoalControl(threading.Thread):
    def __init__(self, threadID):
        ...
        self.listLookAhead = [0.4, 0.5, 0.54, 0.6, 0.65, 0.73, 0.75, 0.8, 0.9, 1.05, 1.28, 1.34, 1.39, 1.44, 1.49]
