...
class MakePathByPoint():
    def __init__(self):
        ...
        self.topic_subPose = rospy.get_param("~topic_subPose", "agv_pose")
        ...
        rospy.Subscriber(self.topic_subPose, Pose, self.callback_poseRobot, queue_size = 20)
        self.is_pose_robot = False
        self.poseRbMa = Pose()
        self.poseStampedAGV = PoseStamped()
        self.theta_robotNow = 0.0
        ...
        self.msgPath = Path()
        self.msgPath.header.frame_id = 'world'
    ...
    def callback_moveRequest(self, data):
        self.msgListPoint.enable = data.enable
        ...
        if data.enable == 1 and self.makePathDone == False:
