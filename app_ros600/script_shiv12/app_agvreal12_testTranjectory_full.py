...
class CanvasWidget(QWidget):
	...
	def makeFullPath(self, listFullPath, r):
		self.listFullPathcv = []
		x_cv = 0
		y_cv = 0
	...
	def paintEvent(self, event):
		...
		if self.isUpdateFullPath:
			...
			ThePainter.drawPoint(self.listFullPathcv[0].startPoint.x, self.listFullPathcv[0].startPoint.y)
		...
		if self.isUpdatePath:
			self.isUpdatePath = False
			ThePen=QPen(Qt.red) # set a color for a pen.  Pens draw lines and outlines
...
class WelcomeScreen(QDialog):
	def __init__(self):
		...
		self.listFullPath  = []
		self.getListFullPath()

	def getListFullPath(self):
		# - Chứa điểm sạc
		ipath1 = infoPath()
		ipath1.typeLine = TypeLine.STRAIGHTLINE
		ipath1.startPoint = Point(3.0, 3.0, 0.0)
		ipath1.endPoint = Point(5.0, 3.0, 0.0)
		ipath1.isTarget = False
		self.listFullPath.append(ipath1)

		# - 
		ipath2 = infoPath()
		ipath2.typeLine = TypeLine.STRAIGHTLINE
		ipath2.startPoint = Point(5.0, 3.0, 0.0)
		ipath2.endPoint = Point(5.0, 1.0, 0.0)
		ipath2.isTarget = False
		self.listFullPath.append(ipath2)

		# - 
		ipath3 = infoPath()
		ipath3.typeLine = TypeLine.STRAIGHTLINE
		ipath3.startPoint = Point(5.0, 1.0, 0.0)
		ipath3.endPoint = Point(1.0, 1.0, 0.0)
		ipath3.isTarget = False
		self.listFullPath.append(ipath3)

		# - 
		ipath4 = infoPath()
		ipath4.typeLine = TypeLine.STRAIGHTLINE
		ipath4.startPoint = Point(1.0, 1.0, 0.0)
		ipath4.endPoint = Point(0.0, 1.0, 0.0)
		ipath4.isTarget = False
		self.listFullPath.append(ipath4)

		# - Điểm nhận  hàng IE5
		ipath5 = infoPath()
		ipath5.typeLine = TypeLine.STRAIGHTLINE
		ipath5.startPoint = Point(0.0, 1.0, 0.0)
		ipath5.endPoint = Point(-1.0, 1.0, 0.0)
		ipath5.isTarget = False
		self.listFullPath.append(ipath5)

		# - 
		ipath6 = infoPath()
		ipath6.typeLine = TypeLine.STRAIGHTLINE
		ipath6.startPoint = Point(-1.0, 1.0, 0.0)
		ipath6.endPoint = Point(-3.0, 1.0, 0.0)
		ipath6.isTarget = False
		self.listFullPath.append(ipath6)

		# - 
		ipath7 = infoPath()
		ipath7.typeLine = TypeLine.STRAIGHTLINE
		ipath7.startPoint = Point(-3.0, 1.0, 0.0)
		ipath7.endPoint = Point(-4.0, 1.0, 0.0)
		ipath7.isTarget = False
		self.listFullPath.append(ipath7)
	...
	def process_normal(self):
		...
		self.TheCanvas.makeFullPath(self.listFullPath, self.ratio)
